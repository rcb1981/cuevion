...
const suites = [
 'src/components/workspace/WorkspaceShell.collaborationEmailSender.test.ts',
 ...
 'src/components/workspace/WorkspaceShell.emailHtmlStage.test.ts',
 'src/components/workspace/WorkspaceShell.threadAppleMailStructure.test.ts',
 'src/components/workspace/WorkspaceShell.threadAppleMailDisclosure.test.ts',
 'src/components/workspace/WorkspaceShell.fullMessageModal.test.ts',
 'src/components/workspace/WorkspaceShell.sentTimestamp.test.ts',
 'src/components/workspace/WorkspaceShell.replyAttachments.test.ts',
];
