...
function Harness() {
  ...
  const activeCollaborationMessageId = 'mail', activeCollaborationSourceMailboxId = 'main', activeCollaborationMessage = { id: 'mail', subject: canonical.source.subject };
  const activeCollaborationOwnerContextKey = 'fixture', currentViewerPersistenceKey = 'fixture-viewer', currentMemberUserId = me, currentUserEmail = 'rutger@example.test', themeMode = 'light';
  ...
  fixture.target = id => {
    fixture.marks = [];
    setIsCollaborationPeopleOpen(false); setIsCollaborationSourceOpen(false); setHighlightedCollaborationMessageId(id);
