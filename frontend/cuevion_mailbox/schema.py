...
mailbox_sync_cursor = sa.Table(
    ...
    sa.Column("scope_key_digest", _HASH, nullable=False),
    ...
    sa.CheckConstraint(
        "scope_key_digest ~ '^[0-9a-f]{64}$'",
        name="scope_key_digest_canonical",
    ),
    sa.CheckConstraint(
...
mailbox_messages = sa.Table(
    ...
    sa.Column("provider_folder_digest", _HASH, nullable=False),
    ...
    sa.CheckConstraint(
        "provider_folder_digest ~ '^[0-9a-f]{64}$'",
        name="provider_folder_digest_canonical",
    ),
    sa.CheckConstraint(
        "("
...
sa.Index(
    ...
    mailbox_messages.c.mailbox_id,
    mailbox_messages.c.source_generation,
    mailbox_messages.c.provider_folder_digest,
