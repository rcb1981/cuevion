...
_TABLE_DDL = (
	...
	CONSTRAINT ck_authentication_identities_issuer_ascii CHECK ((issuer ~ '^[!-~]+$') AND octet_length(issuer) <= 512),
	CONSTRAINT ck_authentication_identities_subject_ascii CHECK ((subject ~ '^[!-~]+$') AND octet_length(subject) <= 512),
	...
	CONSTRAINT ck_initial_account_operations_snapshot_authentication__04890265 CHECK ((snapshot_authentication_identity_issuer ~ '^[!-~]+$') AND octet_length(snapshot_authentication_identity_issuer) <= 512),
	CONSTRAINT ck_initial_account_operations_snapshot_authentication__b9d2e30f CHECK ((snapshot_authentication_identity_subject ~ '^[!-~]+$') AND octet_length(snapshot_authentication_identity_subject) <= 512),
	...
	CONSTRAINT ck_initial_account_operations_snapshot_authentication__0c556b23 CHECK ((snapshot_authentication_evidence_issuer ~ '^[!-~]+$') AND octet_length(snapshot_authentication_evidence_issuer) <= 512),
	CONSTRAINT ck_initial_account_operations_snapshot_authentication__525f7f77 CHECK ((snapshot_authentication_evidence_subject ~ '^[!-~]+$') AND octet_length(snapshot_authentication_evidence_subject) <= 512),
